...
def timeline_map() -> Timeline:
    ...
    gdp = pd.DataFrame(pd.read_csv(r"C:\Users\hujia\Downloads\ddfdc775-f999-4439-8c05-caa7c2c3cb55_Data.csv", header=3))
...
def bar3d_base() -> Bar3D:
    ...
    c = (
        ...
        .set_global_opts(
            title_opts=opts.TitleOpts(title="1979 - 2023年世界各国经济总量柱状图",
                                      title_textstyle_opts=opts.TextStyleOpts(font_size=25, color="black")),
            visualmap_opts=opts.VisualMapOpts(
                max_=150000,
                min_=1,
...
def line_base() -> Line:
    ...
    c = (
        ...
        .set_global_opts(title_opts=opts.TitleOpts(title="1999 - 2023年GDP前10国折线统计图",
...
def bar3d_base0() -> Bar3D:
    ...
    c = (
        ...
        .set_global_opts(
            title_opts=opts.TitleOpts(title="1999 - 2023年世界经济总量前10柱状图",
                                      title_textstyle_opts=opts.TextStyleOpts(font_size=25, color="black")),
            visualmap_opts=opts.VisualMapOpts(
                max_=150000,
                min_=1,
