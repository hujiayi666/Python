...
def timeline_map() -> Timeline:
    ...
    gdp = pd.DataFrame(pd.read_csv(r"C:\Users\hujia\Downloads\API_NY.GDP.MKTP.CD_DS2_en_csv_v2_422027.csv", header=3))
...
def bar3d_base() -> Bar3D:
    ...
    c = (
        ...
        .set_global_opts(
            title_opts=opts.TitleOpts(title="1978 - 2018年世界各国经济总量柱状图",
                                      title_textstyle_opts=opts.TextStyleOpts(font_size=25, color="black")),
            visualmap_opts=opts.VisualMapOpts(
                max_=150000,
                min_=1,
